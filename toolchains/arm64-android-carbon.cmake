...
if (NOT _CCP_TOOLCHAIN_FILE_LOADED)
    ...
    # LTO through a cross-compiler is a common source of link errors that point nowhere
    # useful. Turn this OFF before spending time on an unattributable link failure.
    set (CMAKE_INTERPROCEDURAL_OPTIMIZATION ON CACHE STRING "")

    # No CMAKE_OBJCXX_VISIBILITY_PRESET, CMAKE_XCODE_GENERATE_SCHEME or
    # CMAKE_OSX_DEPLOYMENT_TARGET here — all three are Apple-only. The Android API floor
    # arrives through the triplet's VCPKG_CMAKE_SYSTEM_VERSION instead.
    ...
    set(CCP_PLATFORM "Android" CACHE STRING "Target Platform")
    set(CCP_ARCHITECTURE "arm64" CACHE STRING "Target Architecture")
    set(CCP_TOOLSET "Clang" CACHE STRING "Target Toolset")
    ...
    # NDK r27's clang is 18.x, so this always takes the second branch. The version check is
    # kept so the file stays diffable against its macOS counterpart.
